...
let s:N2 = [ s:c.blue , s:c.surface1 , 149 , 59  ] " guifg guibg ctermfg ctermbg
let s:N3 = [ s:c.text , s:c.base , 145 , 16  ] " guifg guibg ctermfg ctermbg
...
let s:I3 = [ s:c.text , s:c.crust , 145 , 16  ] " guifg guibg ctermfg ctermbg
...
let s:V3 = [ s:c.text , s:c.crust , 145 , 16  ] " guifg guibg ctermfg ctermbg
