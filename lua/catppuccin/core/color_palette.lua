local color_palette = {
	...
	catppuccin6 = "#F6C29C",		-- Tumbleweed
	catppuccin7 = "#C2E5B3",		-- Granny Smith Apple
	catppuccin8 = "#E5DBA0",		-- Megium Champagne
	catppuccin9 = "#779ecb",		-- Cerulean Frost
	catppuccin10 = "#B9C4E3",		-- Periwinkle Crayola
	catppuccin11 = "#6F6A8A",		-- Rhythm
	catppuccin12 = "#3e4058",		-- Independence
	catppuccin13 = "#15121C",		-- Xiketic
	catppuccin14 = "#2C2837",		-- Raisin Black
