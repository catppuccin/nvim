...
function M.get()
	return {
		...
		Folded = { fg = cp.blue, bg = cnf.transparent_background and cp.none or cp.surface1 }, -- line used for closed folds
		...
		TabLineSel = { bg = cp.none }, -- tab pages line, active tab page label
