...
function M.get(user_config)
	...
	return function(defaults)
		...
		local highlights = {
			...
			-- Warnings
			warning = { fg = cp.peach, bg = inactive_bg },
			warning_visible = { fg = cp.peach, bg = inactive_bg },
			warning_selected = { fg = cp.peach, bg = active_bg, style = styles },
			warning_diagnostic = { fg = cp.peach, bg = inactive_bg },
			warning_diagnostic_visible = { fg = cp.peach, bg = inactive_bg },
			warning_diagnostic_selected = { fg = cp.peach, bg = active_bg },
			-- Infos
			info = { fg = cp.teal, bg = inactive_bg },
			info_visible = { fg = cp.teal, bg = inactive_bg },
			info_selected = { fg = cp.teal, bg = active_bg, style = styles },
			info_diagnostic = { fg = cp.teal, bg = inactive_bg },
			info_diagnostic_visible = { fg = cp.teal, bg = inactive_bg },
			info_diagnostic_selected = { fg = cp.teal, bg = active_bg },
			-- Hint
			hint = { fg = cp.sapphire, bg = inactive_bg },
			hint_visible = { fg = cp.sapphire, bg = inactive_bg },
			hint_selected = { fg = cp.sapphire, bg = active_bg, style = styles },
			hint_diagnostic = { fg = cp.sapphire, bg = inactive_bg },
			hint_diagnostic_visible = { fg = cp.sapphire, bg = inactive_bg },
			hint_diagnostic_selected = { fg = cp.sapphire, bg = active_bg },
			-- Diagnostics
